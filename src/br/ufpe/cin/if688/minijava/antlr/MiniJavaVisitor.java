...
public interface MiniJavaVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 */
	T visitOp(@NotNull MiniJavaParser.OpContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitWhileStmt(@NotNull MiniJavaParser.WhileStmtContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MiniJavaParser#intengerLiteral}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIntengerLiteral(@NotNull MiniJavaParser.IntengerLiteralContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MiniJavaParser#bool}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBool(@NotNull MiniJavaParser.BoolContext ctx);
	/**
	 * Visit a parse tree produced by {@link MiniJavaParser#assignStmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssignStmt(@NotNull MiniJavaParser.AssignStmtContext ctx);
	/**
	 * Visit a parse tree produced by {@link MiniJavaParser#arrayAssignStmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArrayAssignStmt(@NotNull MiniJavaParser.ArrayAssignStmtContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MiniJavaParser#printStmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrintStmt(@NotNull MiniJavaParser.PrintStmtContext ctx);
	/**
	 * Visit a parse tree produced by {@link MiniJavaParser#ifStmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIfStmt(@NotNull MiniJavaParser.IfStmtContext ctx);
	/**
